...
<div class="mx-auto max-w-6xl overflow-x-hidden px-4 py-8 sm:px-6">
    <section class="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="<?= BASE_URL ?>/index.php?page=student-assessments" class="inline-flex shrink-0 items-center gap-2 rounded-xl border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-600 no-underline transition-all duration-200 hover:border-slate-300 hover:bg-slate-50">
    ...
    <section class="w-full min-w-0 rounded-2xl border border-amber-200 bg-amber-50 p-8 text-center shadow-sm">
        ...
        <a href="<?= BASE_URL ?>/index.php?page=student-assessments" class="mt-6 inline-flex items-center gap-2 rounded-xl bg-amber-600 px-5 py-2.5 text-sm font-semibold text-white no-underline transition-all duration-200 hover:bg-amber-700">
            Go to Assessments
