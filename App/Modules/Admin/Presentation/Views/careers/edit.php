...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-slate-800 m-0">Edit Career</h1>
        <p class="text-sm text-slate-500 m-0 mt-1">Update this career path information.</p>
    </div>
...
<div class="bg-white rounded-2xl shadow-sm overflow-hidden">
    <div class="p-6">
        <form method="post" action="<?= BASE_URL ?>/index.php?page=admin-careers-update" class="space-y-5">
            <input type="hidden" name="id" value="<?= (int)($old['career_id'] ?? 0) ?>">
