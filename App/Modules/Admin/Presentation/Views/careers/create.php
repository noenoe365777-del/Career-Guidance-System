...
.ts-wrapper.ts-has-error .ts-control { border-color: #ef4444; }
.ts-wrapper.ts-has-error .ts-control:focus { box-shadow: 0 0 0 3px rgba(239,68,68,0.15); }
    ...
    <header class="page-header">
        <div class="page-header-content">
            <div class="page-header-title">
                <h1>Add Career</h1>
                <p>Create a new career recommendation for students.</p>
            </div>
