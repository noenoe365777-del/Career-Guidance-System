            ...
            <div class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-[#f4f7fc]">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Update profile and account settings for this user.</p>
                    </div>
                ...
                <div class="card card-soft">
                    <div class="card-body p-4">
                        <form method="post" action="<?= BASE_URL ?>/index.php?page=admin-users-update">
                            <input type="hidden" name="id" value="<?= (int)($old['user_id'] ?? 0) ?>">
                            <div class="row g-3">
                                <div class="col-md-6">
