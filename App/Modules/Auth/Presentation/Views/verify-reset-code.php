<?php
$pageTitle = $pageTitle ?? 'Verify Reset Code';
$old = $_SESSION['old'] ?? [];
$errors = $_SESSION['errors'] ?? [];
$pendingEmail = $_SESSION['pending_password_reset_email'] ?? '';
$pendingUserId = $_SESSION['pending_password_reset_user_id'] ?? 0;
...
<div class="otp-page-bg">
    <div class="otp-card w-full max-w-[580px] mx-4 bg-white rounded-2xl border border-slate-200/80 shadow-[0_6px_30px_rgba(0,0,0,0.05)] p-6 sm:p-8">
        ...
        <div class="text-center mb-4">
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Enter Verification Code</h1>
        </div>
        ...
        <!-- OTP Form -->
        <form action="<?= BASE_URL ?>/index.php?page=verify-reset-code" method="post" id="otpForm" novalidate>
            ...
            <!-- Email Info (moved above OTP inputs) -->
            ...
            <!-- OTP Inputs -->
            <div class="flex justify-center gap-2.5 sm:gap-3 mb-3" role="group" aria-label="Verification code inputs">
            ...
            <!-- Timer (directly below OTP inputs) -->
            <div class="text-center mb-3">
            ...
            <!-- Verify Button (immediately below timer) -->
