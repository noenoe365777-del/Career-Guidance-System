...
<!-- Hero Section -->
<section class="relative bg-white py-6 lg:py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-[#0f2d59] leading-[1.1]">
            Visit Our Office
        </h1>
        <p class="text-sm text-slate-500 max-w-2xl mx-auto font-medium mt-3 leading-relaxed">
...
<!-- Address Content -->
<section class="max-w-7xl mx-auto px-4 sm:px-6 py-4 lg:py-6">
    ...
    <div class="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        ...
        <nav class="flex items-center gap-1.5 text-xs font-medium text-slate-400">
            ...
            <span class="text-[#0f2d59]">Address</span>
        </nav>
    </div>

    <div class="grid lg:grid-cols-2 gap-6 lg:gap-8 items-start max-w-5xl mx-auto">

        <!-- Left: Large Embedded Google Map -->
        <div>
            <div class="bg-white border border-slate-100 shadow-md rounded-xl overflow-hidden">
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-xl border border-slate-100 shadow-md p-6">
                <div class="flex items-center gap-4 mb-5">
                    <div class="w-11 h-11 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center flex-shrink-0 shadow-lg shadow-blue-200/50">
                    ...
                    <div>
                        <h3 class="text-base font-bold text-[#0f2d59]">Office Address</h3>
            ...
            <div class="bg-white rounded-xl border border-slate-100 shadow-md p-6">
                <div class="flex items-center gap-4 mb-5">
                    ...
                    <div>
                        <h3 class="text-base font-bold text-[#0f2d59]">Office Hours</h3>
                ...
                <div class="space-y-2.5 text-sm">
                    <div class="flex justify-between py-2 border-b border-slate-100 last:border-0">
                        ...
                        <span class="font-semibold text-[#0f2d59]">9:00 AM – 6:00 PM</span>
                    </div>
                    <div class="flex justify-between py-2 border-b border-slate-100 last:border-0">
                        <span class="text-slate-500">Saturday</span>
                        <span class="font-semibold text-[#0f2d59]">10:00 AM – 2:00 PM</span>
                    </div>
                    <div class="flex justify-between py-2">
                        <span class="text-slate-500">Sunday</span>
                        <span class="font-semibold text-[#0f2d59]">Closed</span>
                    </div>
                </div>
            </div>
            ...
            <a href="https://maps.google.com/?q=Yangon+Myanmar" target="_blank" rel="noopener noreferrer"
               class="inline-flex items-center gap-2 w-full px-4 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold text-sm rounded-lg shadow hover:shadow-md transition-all duration-200 justify-center no-underline">
